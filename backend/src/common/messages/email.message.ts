...
export const RESET_PASSWORD = "puedes restablecer tu contraseña en el siguiente enlace";
export const RESET_PASSWORD_BUTTON = "Reestablecer contraseña";
export const RESET_PASSWORD_SUBJECT = "Cambio de contraseña en Jenika - PORTAFOLIO";